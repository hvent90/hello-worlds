...
- [raymath cheatsheet](/cheatsheet/raymath_cheatsheet.html)

::: {#copyright}
[![librecounter](https://librecounter.org/counter.svg){referrerpolicy="unsafe-url"
width="20"}](https://librecounter.org/referer/show){target="_blank"}

raylib quick reference card - Copyright (c) 2013-2025 Ramon Santamaria
([\@raysan5](https://www.twitter.com/raysan5))
:::
:::::::::::::::
